...
using TreasureHunter.Server.TimsoFameModels;

namespace TreasureHunter.Server.TreasureHunterGameModels
{
    [Authorize]
    public class TreasureHunterHub : Hub
    {
        ...
        /// </summary>
        private static readonly List<TreasureHunterGame> games = new List<TreasureHunterGame>();
        ...
        public void AcceptInvitation(string opponentId, string connectionId, int totalNumber)
        {
            ...
            var game = new TreasureHunterGame(totalNumber) { Player1 = player, Player2 = opponent };
            //Save to database
